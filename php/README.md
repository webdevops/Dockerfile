...
`webdevops/php:centos-7-php56`      |                          | PHP 5.6.18 (via webtatic)
...
`/opt/docker/etc/oracle/tnsnames.ora`                  | SQL configuration file that defines databases addresses for Oracle ( available for centos-7-php56)
